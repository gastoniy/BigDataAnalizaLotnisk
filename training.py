...
sanitized_df = transformer.transform(threshold_minutes=15, encoding="label") # since the model itself is going to be saved, there's no point in savng csv now
...
joblib.dump(final_model, 'flights_random_forest_label.joblib')
joblib.dump(transformer.encoder, "airline_label.joblib")