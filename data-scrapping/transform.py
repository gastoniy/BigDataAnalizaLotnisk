...
# Baza i katalog wyjściowy CSV są kotwiczone względem tego skryptu (data-scrapping/),
# a nie katalogu roboczego — kanoniczna baza leży w ../data/.
_TU = os.path.dirname(os.path.abspath(__file__))
_DB_PATH = os.path.join(_TU, "..", "data", "baza_lotow.db")
_DATA_DIR = os.path.join(_TU, "..", "data")
...
def export_to_csv():
    ...
    nazwa_pliku = os.path.join(_DATA_DIR, f"dataset_loty_krakow_{timestamp}.csv")
